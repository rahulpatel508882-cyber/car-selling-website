...
const WhyUs = () => {
  ...
  return (
    <div className='flex flex-col justify-center container md:mt-16 py-10'>
      ...
      '>At Premium Wheels, we understand that true luxury is about more than just a destination – it’s about the experience.</p>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 gap-5'>
          <WhyUsCard icon={icon1} title=" Financing Options"/>
          <WhyUsCard icon={icon2} title=" Satiesfied Customers"/>
